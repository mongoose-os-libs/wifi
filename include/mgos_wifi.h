...
enum mgos_wifi_event {
  MGOS_WIFI_AP_STA_CONNECTED =
  MGOS_WIFI_EV_BASE, // struct mgos_wifi_ap_sta_connected_arg*
  MGOS_WIFI_AP_STA_DISCONNECTED, // struct mgos_wifi_ap_sta_connected_arg*
};
...
struct mgos_wifi_ap_clients {
  int num_clients;
  struct mgos_wifi_ap_sta_connected_arg *client;
};
